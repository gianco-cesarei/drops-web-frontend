    ...
    <main className="producer-settings-page">
      ...
      <div className="settings-two-column-layout">
        ...
        <section className="settings-card verification-card">
          <div
            className="card-section-title settings-section-heading"
            ...
            <div style={{ display: 'flex', gap: '12px', alignItems: 'center' }}>
              ...
              <div>
                ...
                <p className="card-subtext" style={{ margin: 0 }}>
                  Collega almeno <strong>UNO</strong> dei tuoi profili esterni per sbloccare la spunta <strong>✓</strong>.
                </p>
              </div>
            </div>
            <button type="button" className="btn-sort-pill" style={{ fontSize: '11px', padding: '3px 8px' }}>
              {socialsOpen ? '▲ Riduci' : '▼ Espandi'}
            </button>
          </div>

          {socialsOpen && (
            <>
              <div className="connected-accounts-stack" style={{ marginTop: '12px' }}>
                {/* INSTAGRAM */}
              ...
              <div className="verification-rule-hint" style={{ marginTop: '12px' }}>
                <span className="hint-icon">ℹ️</span>
                <span>
                  In questo prototipo la spunta indica una presenza esterna inserita localmente. Scollegando tutti gli account, il badge sparisce.
                </span>
              </div>
            </>
          )}
          ...
          {/* ALTRI LINK MUSICALI */}
          <div className="extra-links-group" style={{ marginTop: '1.5rem', borderTop: '1px solid var(--color-border)', paddingTop: '1rem' }}>
            <div
              style={{ display: 'flex', justifyContent: 'space-between', alignItems: 'center', cursor: 'pointer', marginBottom: extraLinksOpen ? '12px' : 0 }}
              onClick={() => setExtraLinksOpen((v) => !v)}
            >
              <h3 style={{ margin: 0, fontSize: '15px' }}>Altri Link &amp; Profili Artistici</h3>
              <button type="button" className="btn-sort-pill" style={{ fontSize: '11px', padding: '3px 8px' }}>
                {extraLinksOpen ? '▲ Riduci' : '▼ Espandi'}
              </button>
            </div>
          ...
          >
            <div style={{ display: 'flex', gap: '12px', alignItems: 'center' }}>
              ...
              <div>
                ...
                <p className="card-subtext" style={{ margin: 0 }}>Informazioni pubbliche e DAW in studio.</p>
              </div>
            </div>
            <div style={{ display: 'flex', gap: '6px', alignItems: 'center' }} onClick={(e) => e.stopPropagation()}>
              ...
              <button type="button" className="btn-sort-pill" onClick={() => setDetailsOpen((v) => !v)} style={{ fontSize: '11px', padding: '3px 8px' }}>
                {detailsOpen ? '▲ Riduci' : '▼ Espandi'}
              </button>
            </div>
          </div>
